...
<script type="text/javascript"
	src="/60TeamProject_TransportRisk/js/bootstrap.min.jss"></script>
			...
			<div class="col-md-9" id="col-md">
				<fieldset id="tjbInfo">
					...
					<form class="form-inline">
						...
						从&nbsp;&nbsp;<input type="text" class="form-control input-sm"
							value="2011-07-15">&nbsp;到&nbsp;<input type="text"
							class="form-control input-sm" value="2011-08-15">
					</form>
					<form class="form-inline">
						&nbsp;&nbsp;&nbsp;&nbsp;运输工具名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" class="form-control input-sm"
