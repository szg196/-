    ...
    <div class="row">
        ...
        <div class="col-md-9" id="col-md">
            <fieldset id="tjbInfo">
                ...
                <form class="form-inline">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;货物类型：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <select class="form-control input-sm" style="width: 37%" disabled="disabled">
                        <option>轻纺、文体、日用品、工艺品</option>
                    </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" class="checkbox" checked="checked">&nbsp;不限类型
                </form>
                <form class="form-inline">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <select class="form-control input-sm" style="width: 57%" disabled="disabled">
                        <option>旅行用品、手提包及类似容器</option>
                    </select>
                </form>
                <form class="form-inline">
                    &nbsp;&nbsp;&nbsp;&nbsp;运输工具名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
