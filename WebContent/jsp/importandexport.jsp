    ...
    <div class="row">
        ...
        <div class="col-md-9 bgc" id="rightDiv">
            <fieldset id="tjbInfo" >
                ...
                <form class="form-horizontal" onsubmit="false">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input  type="text" class="form-control input-sm" id="tbName" placeholder="投保人名称">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bbxrmc" class="col-sm-4 control-label">被投保人名称</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control input-sm" id="btbName" placeholder="被保人名称">
                        </div>
                    </div>
                </form>
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control input-sm" id="tbAddress" placeholder="地址">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bbxrdz" class="col-sm-3 control-label">地址</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control input-sm" id="btbAddress" placeholder="地址">
                        </div>
                    </div>
                </form>
            </fieldset>
            <fieldset id="tjbInfo2" >
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="tbrmc" class="col-sm-5 control-label">合同号</label>
                        <label for="tbrmc" class="col-sm-5 control-label">标记</label>
                    </div>
                    <div class="form-group">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <textarea id="casesNum" class="col-sm-3 form-control  leftp" style="width: 25%"></textarea>
            ...
            <fieldset class="tjbInfo">
                <legend>运输信息</legend>
                    ...
                    <div class="form-group col-sm-12" >
                            ...
                            <span>经过</span>
                            <input id="linePass" type="text" class="w2 form-control input-sm">
                            <span>到</span>
                            <input id="lineArrive" type="text" class="w2 form-control input-sm">

                            <label for="tbrmc" class=" control-label">理赔代理</label>
                            <select id="claims" class="w1">
            ...
            <fieldset class="tjbInfo">
                ...
                <form class="form-horizontal">
                    <div class="form-group col-sm-11">
                        ...
                        <select id="clause-type" class="col-sm-7">
                            <option>人保运输货物保险条款</option>
                        </select>
                    </div>
                    <div class="form-group col-sm-11">
                        <label  class="col-sm-4 ">主险条款</label>
                        <select id="zhuXian-type" class="col-sm-7">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <input id="creditNum" type="text" class="w2 form-control input-sm" style="width: 140px;">
                        <label  class="">保险单正本份数描述</label>
                        <input id="copiesDescription" type="text" class="w2 form-control input-sm" style="width: 40px;">
                    </div>
                </form>
            </fieldset>
            <fieldset class="tjbInfo" id="bxinfo">
                ...
                <form class="form-horizontal forma">
                    <div class="form-group rightmar col-sm-12" >
                        ...
                        <input id="invoiceMoney" type="text" class="w3 form-control input-sm">
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="tbrmc" class="control-label">保险金额</label>
                        <input id="money" type="text" class="w4 form-control input-sm">
                        <label for="tbrmc" class="control-label">费率</label>
                        <input id="rate" type="text" class="w4 form-control input-sm">
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="tbrmc" class="control-label">赔偿币种</label>
                        <input id="indemnityCurrency" type="text" class="w3 form-control input-sm" readonly="readonly" placeholder="人名币">
                        <label for="tbrmc" class="control-label">赔款偿付地</label>
                        <input id="indemnityAddress" type="text" class="w4 form-control input-sm" >
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="tbrmc" class="control-label col-sm-2">绝对免赔率</label>
                        <textarea id="excess" class="col-sm-6 form-control" style="height: 80px;display: inline-block;width: 65%">
                        </textarea>
                ...
                <form class="form-horizontal formb">
                    <div class="form-group">
                        ...
                        <input id="additionRatio" type="text" class="form-control w5 input-sm">
                        <label for="tbrmc" class="control-label">%</label>
                    </div>
                    <div class="form-group">
                        <label for="tbrmc" class="control-label" style="margin-left: 30px">保费</label>
                        <input id="premium" type="text" class="form-control w6 input-sm" readonly="readonly" placeholder="0.0">
                    </div>
                    <div class="form-group">
                        <label for="tbrmc" class="control-label">结算币种</label>
                        <select id="clearingCurrency" class="w6">
                            <option value="0">人名币</option>
                            <option value="1">美元</option>
                            <option value="2">英镑</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input id="signingDate" type="text" class="form-control w5 input-sm" placeholder="2011-1-1">
                    </div>
                    <div class="form-group">
                        <label for="tbrmc" class="control-label">起运日期</label>
                        <input id="shippingDate" type="text" class="form-control w5 input-sm" placeholder="2011-1-1">
                    </div>
                </form>
                <form class="form-horizontal formc">
                    <div class="form-group col-sm-12">
                        <label for="tbrmc" class="control-label col-sm-2">特别约定</label>
                        <textarea id="specialAppoint" class="col-sm-10 form-control " style="margin-top: 20px"></textarea>
                    </div>
                </form>
            </fieldset>
            <fieldset>
                ...
                <form class="form-horizontal formc">
                    <div class="form-group col-sm-12">
                        ...
                        <input id="code" type="text" class="col-sm-6 form-control w5 input-sm ">
